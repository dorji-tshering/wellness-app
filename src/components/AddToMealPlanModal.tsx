        ...
        if(mealData.mealPlan && mealData.mealDay && mealData.meal) {
            ...
            try {
                await updateDoc(doc(database, 'mealplans', mealData.mealPlan?.id), {
                    dayOne: {
                        breakfast: mealData.mealDay === 'dayOne' && mealData.meal === 'breakfast' ? recipeId : '',
                        lunch: mealData.mealDay === 'dayOne' && mealData.meal === 'lunch' ? recipeId : '',
                        dinner: mealData.mealDay === 'dayOne' && mealData.meal === 'dinner' ? recipeId : '',
                    },
                    dayTwo: {
                        breakfast: mealData.mealDay === 'dayTwo' && mealData.meal === 'breakfast' ? recipeId : '',
                        lunch: mealData.mealDay === 'dayTwo' && mealData.meal === 'lunch' ? recipeId : '',
                        dinner: mealData.mealDay === 'dayTwo' && mealData.meal === 'dinner' ? recipeId : '',
                    },
                    dayThree: {
                        breakfast: mealData.mealDay === 'dayThree' && mealData.meal === 'breakfast' ? recipeId : '',
                        lunch: mealData.mealDay === 'dayThree' && mealData.meal === 'lunch' ? recipeId : '',
                        dinner: mealData.mealDay === 'dayThree' && mealData.meal === 'dinner' ? recipeId : '',
                    },
                    dayFour: {
                        breakfast: mealData.mealDay === 'dayFour' && mealData.meal === 'breakfast' ? recipeId : '',
                        lunch: mealData.mealDay === 'dayFour' && mealData.meal === 'lunch' ? recipeId : '',
                        dinner: mealData.mealDay === 'dayFour' && mealData.meal === 'dinner' ? recipeId : '',
                    },
                    dayFive: {
                        breakfast: mealData.mealDay === 'dayFive' && mealData.meal === 'breakfast' ? recipeId : '',
                        lunch: mealData.mealDay === 'dayFive' && mealData.meal === 'lunch' ? recipeId : '',
                        dinner: mealData.mealDay === 'dayFive' && mealData.meal === 'dinner' ? recipeId : '',
                    },
                    daySix: {
                        breakfast: mealData.mealDay === 'daySix' && mealData.meal === 'breakfast' ? recipeId : '',
                        lunch: mealData.mealDay === 'daySix' && mealData.meal === 'lunch' ? recipeId : '',
                        dinner: mealData.mealDay === 'daySix' && mealData.meal === 'dinner' ? recipeId : '',
                    },
                    daySeven: {
                        breakfast: mealData.mealDay === 'daySeven' && mealData.meal === 'breakfast' ? recipeId : '',
                        lunch: mealData.mealDay === 'daySeven' && mealData.meal === 'lunch' ? recipeId : '',
                        dinner: mealData.mealDay === 'daySeven' && mealData.meal === 'dinner' ? recipeId : '',
                    },
                })
            ...
            <div className="max-h-full overflow-auto rounded-md" onClick={(e) => e.stopPropagation()}>
                ...
                { mealPlans && mealPlans?.length > 0 && showMealPlanOptions && (
                    <div className='absolute top-0 right-0 left-0 bottom-0 z-40 flex items-center justify-center bg-black/30 px-4 py-5'
                        onClick={() => setShowMealPlanOptions(false)}>
                ...
                { showMealDayOptions && (
                    <div className='absolute top-0 right-0 left-0 bottom-0 z-40 flex items-center justify-center bg-black/30 px-4 py-5'
                        onClick={() => setShowMealDayOptions(false)}>
                        <div className="max-h-full overflow-auto rounded-md min-w-[200px]" 
                            onClick={(e) => e.stopPropagation()}>
                            <ul className='bg-white rounded-md py-2'>
