...
import { fetchMealplans, selectFetchStatus, selectMealplans } from '../state/mealplans/mealplans.slice';

const NutrientStats = () => {
    const user = useAuthValue();
    const mealDays = ['dayOne', 'dayTwo', 'dayThree', 'dayFour', 'dayFive', 'daySix', 'daySeven'] as const;
    const activeMealplan = useAppSelector(selectMealplans).find(plan => plan.active);
